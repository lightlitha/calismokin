        ...
        <div class="col-xs-12 col-sm-5 col-md-4 login-sidebar">
            ...
            <div class="login-container">
                ...
                <form method="POST" action="{{ route('register') }}">
                    {{ csrf_field() }}
                    <div class="form-group form-group-default" id="username">
                    ...
                    <div class="form-group form-group-default" id="passwordGroup">
                        <label>Confirm {{ __('voyager::generic.password') }}</label>
                        <div class="controls">
                            <input type="password" name="password_confirmation" placeholder="{{ __('voyager::generic.password') }}" class="form-control" required>
                        </div>
                    </div>
